 ...
 * Date : 17.05.2018
 * projet: SimpleTab
 * description : page de résultat des recherches
 */
...
<script type="text/javascript">
    $( document ).ready(function() {
            ...
            get_data("../controller/getTabAndRelatedArtistByName.php",getTabAndRelatedArtistByName,{'tabTitleOrArtistNAme' :tabTitleOrArtistNAme},true);
        ...
        $('#btnAddUser').click(function () {
            ...
            get_data("../controller/getUserByPseudo.php",getUserByPseudo,{'pseudo' : pseudo},true);
            function getUserByPseudo(dataPseudo)
            {
                if(dataPseudo == false)
                {
                    get_data("../controller/getUserByEmail.php",getUserByEmail,{'email' : email},true);
                    function getUserByEmail(dataEmail)
                    {
                        if(dataEmail == false)
                        {
                        ...
                        {
                            alert('Ce mail est déjà pris, veuillez en utiliser un autre');
                        }
                    }
                ...
                {
                    alert('Ce pseudo est déjà pris, veuillez en utiliser un autre');
                }
            }
        });
